...
router.post('/asistencias/incidencias/resolver', requirePermission(PERMISSIONS.RRHH_MANAGE), rrhhController.resolverIncidenciaAsistencia);
router.patch('/sobretiempo/:id/resolver', requirePermission(PERMISSIONS.RRHH_MANAGE), rrhhController.resolverSobretiempo);
...
router.patch('/permisos/:id/cancelar', requirePermission(PERMISSIONS.RRHH_MANAGE), rrhhController.cancelarPermiso);
...
router.patch('/justificaciones/:id/resolver', requirePermission(PERMISSIONS.RRHH_MANAGE), rrhhController.resolverJustificacionAsistencia);
...
router.patch('/vacaciones/:id/cancelar', requirePermission(PERMISSIONS.RRHH_MANAGE), rrhhController.cancelarVacaciones);

// Pagos mensuales por servicios (Recibos por Honorarios)
router.get('/pagos', requirePermission(PERMISSIONS.RRHH_VIEW), servicePaymentController.dashboard);
router.get('/pagos/historial', requirePermission(PERMISSIONS.RRHH_VIEW), servicePaymentController.history);
router.get('/pagos/empleados/:id/expediente', requirePermission(PERMISSIONS.RRHH_VIEW), servicePaymentController.employeeLedger);
router.post('/pagos/empleados/:id/notas', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.addEmployeeNote);
router.patch('/pagos/notas/:id/anular', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.cancelEmployeeNote);
router.post('/pagos/periodos/generar', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.generate);
router.post('/pagos/periodos/:id/transicion', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.transitionPeriod);
router.post('/pagos/periodos/:id/lotes', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.createBatch);
router.put('/pagos/empleados/:id/acuerdo', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.saveAgreement);
router.post('/pagos/movimientos', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.createMovement);
router.post('/pagos/prestamos', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.createLoan);
router.put('/pagos/liquidaciones/:id/recibo', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.registerReceipt);
router.post('/pagos/liquidaciones/:id/deposito', requirePermission(PERMISSIONS.RRHH_MANAGE), servicePaymentController.markPaid);
