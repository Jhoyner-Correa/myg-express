...
describe('RouteLookupPanel', () => {
  it('oculta la importaci\u00f3n y la ruta destino en modo de solo lectura', () => {
    render(<RouteLookupPanel {...defaults} canManage={false} />);
    expect(screen.getByText('N\u00famero de ruta')).toBeInTheDocument();
    expect(screen.getByRole('option', { name: 'Gu\u00eda A\u2013Z' })).toBeInTheDocument();
  ...
  it('habilita controles de importaci\u00f3n para usuarios gestores', () => {
