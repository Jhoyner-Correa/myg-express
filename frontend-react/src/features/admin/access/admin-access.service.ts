...
export const adminAccessService = {
  ...
  async updateMyModules(moduleCodes: string[]): Promise<UpdateMyModuleAccessResult> {
    const response = await apiClient.patch('/admin/usuarios/me/modules', {
